...
const ProbabilityBay: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"quantum" | "classical">(
    "quantum",
  );
  ...
  const getExpectedLockerCode = (histogram: number[]): string => {
    ...
    const mostFrequentIndices = histogram
      .map((c, i) => (c === max ? i : -1))
      .filter((i) => i !== -1);
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="bg-purple-900/30 border border-purple-500 rounded-xl p-4">
                  ...
                  <ol className="text-purple-200 text-sm list-decimal list-inside space-y-1">
                    <li>Roll both Quantum and Classical dice</li>
                    <li>
                      Compare the results - quantum dice will show a pattern
                    </li>
                    <li>Find the most common number from Quantum rolls</li>
                    <li>Pick that locker number and enter it as the code</li>
                    <li>Unlock!</li>
                  </ol>
                </div>
                <div className="bg-red-900/30 border border-red-500 rounded-xl p-4">
                  ...
                  <p className="text-red-200 text-sm">
                    Pick the locker number that matches your most frequent
                    quantum roll!
                  </p>
                </div>
              </div>
        ...
        <div className="text-center mb-8">
          ...
          <div className="mb-4 p-4 rounded-xl bg-gradient-to-r from-purple-900/60 to-blue-900/60 border border-blue-700 shadow-lg">
            <p className="text-base text-blue-200 font-semibold mb-2">
              ...
              Compare classical probability with quantum measurement effects
            </p>
            <p className="text-base text-blue-100">
              Observe how quantum systems exhibit interference patterns unlike
        ...
        <div className="grid lg:grid-cols-2 gap-8">
            ...
            {activeTab === "quantum" ? (
                ...
                {measurements.length > 0 && (
                  <div className="mb-6">
                    <p className="text-gray-300 mb-4">
                      Quantum Measurements: {measurements.length}/50
                    </p>
                ...
                {showHistogram && (
                  <div className="mt-6">
                    ...
                    <p className="text-sm text-gray-400 mb-4">
                      Notice the interference pattern - some outcomes are
                      enhanced while others are suppressed
                    </p>
                    <div className="space-y-2">
                      {getHistogramData(measurements).map((count, index) => {
                        ...
                        const isMostProbable =
                          measurements.length > 0 &&
                          (index + 1).toString() ===
                            getExpectedLockerCode(
                              getHistogramData(measurements),
                            );
              ...
              <>
                ...
                <div className="text-center mb-6">
                  ...
                  >
                    {isClassicalRolling
                      ? "Rolling Classical Dice..."
                      : "Roll Classical Dice (n=50)"}
                  </button>
                ...
                {classicalMeasurements.length > 0 && (
                  <>
                    <div className="mb-6">
                      <p className="text-gray-300 mb-4">
                        Classical Rolls: {classicalMeasurements.length}/50
                      </p>
                      <div className="flex flex-wrap gap-2">
                        {classicalMeasurements
                          .slice(-10)
                          .map((result, index) => (
                            <div
                              key={index}
                    ...
                    <div className="mt-6">
                      ...
                      <p className="text-sm text-gray-400 mb-4">
                        Expected uniform distribution (~16.67% per outcome)
                      </p>
                      <div className="space-y-2">
                        {getHistogramData(classicalMeasurements).map(
                          (count, index) => {
                            const percentage =
                              (count / classicalMeasurements.length) * 100;
          ...
          <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-gray-700 p-6">
            ...
            <p className="text-gray-300 mb-6">
              The quantum lockers respond only to the true interference pattern.
              Use the quantum measurement results (not classical) to identify
              the correct eigenstate.
            </p>
              ...
              {LOCKER_NUMBERS.map((locker) => (
                ...
                >
                  <div className="text-center">
                    ...
                    locker ===
                      Number.parseInt(
                        getExpectedLockerCode(getHistogramData(measurements)),
                      ) ? (
            ...
            {decoySolved && !roomCompleted && (
              <div className="mt-6 p-4 bg-red-900/30 border border-red-500 rounded-xl">
                ...
                <p className="text-red-200 text-sm mt-2">
                  You entered the correct eigenvalue, but the selected locker
                  was not aligned with the true quantum interference pattern.
                  Ensure you select the locker corresponding to the **single
                  most probable outcome** from your quantum measurements.
                </p>
              </div>
            )}
            {roomCompleted && (
              <div className="mt-6 p-4 bg-green-900/30 border border-green-500 rounded-xl">
                <p className="text-green-300 font-semibold">
                  🎉 Quantum System Stabilized!
                </p>
                <p className="text-green-200 text-sm mt-2 mb-4">
                  You've successfully identified the true quantum probability
                  distribution!
                </p>
                <FeedbackButton
