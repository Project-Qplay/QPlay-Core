        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-gray-900 bg-opacity-50 backdrop-blur-sm border border-gray-800 rounded-lg p-4 h-60">
            <div className="flex items-center mb-2">
              ...
              <span className="text-gray-400 text-xs">quantum_terminal.js</span>
            </div>
            <div
            ...
            >
              {codeLines.map((line, i) => (
                <div key={i} className="mb-1">
                  ...
                  <span className={line.startsWith("//") ? "text-blue-400" : line.includes("quantum") || line.includes("Quantum") ? "text-purple-400" : "text-cyan-300"}>
                    {line}
                  </span>
                </div>
              ))}
              {blinkCursor && <span className="inline-block w-2 h-4 bg-cyan-400 ml-1"></span>}
            </div>
          </div>

          {/* Right column - ASCII Art and Loading Status */}
          <div className="bg-gray-900 bg-opacity-50 backdrop-blur-sm border border-gray-800 rounded-lg p-4 flex flex-col h-60">
            <div className="flex items-center mb-2">
              <div className="w-3 h-3 rounded-full bg-red-500 mr-2"></div>
              <div className="w-3 h-3 rounded-full bg-yellow-500 mr-2"></div>
              <div className="w-3 h-3 rounded-full bg-green-500 mr-2"></div>
